#!/usr/bin/env python3
"""
Shim Generator: Reads catalog/registry.yaml and creates wrapper scripts in system/bin/
Usage: python3 ops/governance/generate_shims.py
"""
import os
import sys
import yaml
...
REGISTRY_PATH = ROOT / "catalog/registry.yaml"
BIN_DIR = ROOT / "system/bin"
LOOKUP_TOOL = ROOT / "tools/catalog_lookup.zsh"
...
# Resolve absolute path via lookup tool
