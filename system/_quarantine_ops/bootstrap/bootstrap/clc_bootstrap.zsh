#!/usr/bin/env zsh
# clc_bootstrap.zsh — verify ~/gd symlink + refresh SOT links under ~/02luka/google_drive/
# Usage: zsh tools/bootstrap/clc_bootstrap.zsh
