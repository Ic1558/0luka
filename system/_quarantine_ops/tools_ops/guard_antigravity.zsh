#!/usr/bin/env zsh
# guard_antigravity.zsh — monitor for new/respawned AI processes + swap threshold
# Usage: [SWAP_GB=4] [PATTERN=...] [STATE_FILE=~/.antigravity_guard.state] zsh guard_antigravity.zsh
# Designed to be called from a LaunchAgent on a timer (e.g. every 60s).
set -euo pipefail
