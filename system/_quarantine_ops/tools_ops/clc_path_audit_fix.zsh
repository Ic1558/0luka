#!/usr/bin/env zsh
# clc_path_audit_fix.zsh — audit (and optionally fix) legacy hardcoded paths in repo files
#
# Usage:
#   DRYRUN=1 zsh tools/ops/clc_path_audit_fix.zsh   # audit only (default)
#   DRYRUN=0 zsh tools/ops/clc_path_audit_fix.zsh   # apply fixes with backups
set -euo pipefail
set +H
