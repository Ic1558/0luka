#!/usr/bin/env zsh
# gg_autofix_after_reboot.zsh — post-reboot LaunchAgent path-patch + restart + GD check
# Usage: zsh gg_autofix_after_reboot.zsh
# Safe to re-run. Idempotent: backs up each plist only once per run.
set -euo pipefail
