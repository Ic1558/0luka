#!/usr/bin/env zsh
# wo_bind_gd_and_cleanup.zsh — one-shot: bind ~/gd to active My Drive + cleanup ~/luka symlink
# ARCHIVED: one-off GD migration script from env setup phase.
set -euo pipefail
...
print; ok "เสร็จสิ้น — แนะนำ: exec zsh แล้วลอง cd ~/gd/02luka"
